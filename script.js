$(document).ready(function() {
  ...
  function createElement(data) {
    ...
    element.find('[data-result-time-section] [data-result-time-paragraph]').text(data.time);
    element.find('[data-result-time-section] [data-result-time-input]').val(data.time);
  ...
  function handleResultUpdateRequest() {
    ...
    var resultTime = parentEl.find('[data-result-time-input]').val();
    var resultPatrolType = parentEl.find('[data-result-patrolType-input]').val();
    var resultNick = parentEl.find('[data-result-nick-input]').val();
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        parentEl.find('[data-result-time-paragraph]').text(resultTime);
        parentEl.find('[data-result-patrolType-paragraph]').text(resultPatrolType);
        parentEl.find('[data-result-nick-paragraph]').text(resultNick);
  ...
  function handleResultSubmitRequest(event) {
    ...
    var resultTime = $(this).find('[name="time"]').val();
    var resultPatrolType = $(this).find('[name="patrolType"]').val();
    var resultNick = $(this).find('[name="nick"]').val();
  ...
  function toggleEditingState() {
    ...
    var resultTime = parentEl.find('[data-result-time-paragraph]').text();
    var resultPatrolType = parentEl.find('[data-result-patrolType-paragraph]').text();
    var resultNick = parentEl.find('[data-result-nick-paragraph]').text();
